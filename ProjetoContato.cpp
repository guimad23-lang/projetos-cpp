...
public:
    ...
    // Método para calcular a idade exata com base no sistema operacional
    int idade() {
...
int main() {
    ...
    for (int i = 0; i < TAMANHO; i++) {
        ...
        // Limpa o buffer do teclado para o próximo getline não ser pulado
        cin.ignore(numeric_limits<streamsize>::max(), '\n');

        // Instancia a data e salva no objeto Contato atual
